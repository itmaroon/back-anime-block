...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/wave/editor.scss");
/* harmony import */ var _CustomFooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../CustomFooks */ "./CustomFooks.js");
...
function Edit({
  ...
  (0,_CustomFooks__WEBPACK_IMPORTED_MODULE_3__.useDeepCompareEffect)(() => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, {
    ...
    settings: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Choice color"),
    ...
    step: 0.5,
    withInputField: false
  }))), is_mulutiwave && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: "\u6CE2\uFF12\u306E\u8A2D\u5B9A",
    initialOpen: true,
    className: "back_design_ctrl"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.__experimentalPanelColorGradientSettings, {
    ...
    min: 0.5,
    onChange: val => setAttributes({
      second_wave_size: val
    }),
    separatorType: "none",
    step: 0.5,
    withInputField: false
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("canvas", {
    id: "waveCanvas"
  })));
}
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"itmar/wave","version":"0.1.0","title":"Wave","category":"design","description":"波が動く様子のアニメーションです","attributes":{"first_Color":{"type":"string","default":"#11a0ad"},"second_Color":{"type":"string","default":"#11a0ad"},"is_mulutiwave":{"type":"boolean","default":true},"wave_height":{"type":"number","default":200},"first_wave_size":{"type":"number","default":3},"second_wave_size":{"type":"number","default":2}},"supports":{"html":false},"textdomain":"degital","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
